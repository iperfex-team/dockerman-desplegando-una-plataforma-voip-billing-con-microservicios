...
--
-- Host: a2b-mariadb    Database: a2billing
-- ------------------------------------------------------
...
CREATE TABLE `cc_call` (
  ...
  `calledstation` varchar(100) COLLATE utf8_bin NOT NULL,
  ...
  `a2b_custom1` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `a2b_custom2` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
...
/*!50001 CREATE TABLE `cc_callplan_lcr` (
  ...
  `dialprefix` tinyint NOT NULL,
  `buyrate` tinyint NOT NULL,
  `rateinitial` tinyint NOT NULL,
  `startdate` tinyint NOT NULL,
  `stopdate` tinyint NOT NULL,
  `initblock` tinyint NOT NULL,
  `connectcharge` tinyint NOT NULL,
  `id_trunk` tinyint NOT NULL,
  `idtariffplan` tinyint NOT NULL,
  `ratecard_id` tinyint NOT NULL,
  `tariffgroup_id` tinyint NOT NULL
) ENGINE=MyISAM */;
...
CREATE TABLE `cc_card` (
  ...
  `max_concurrent` int(11) NOT NULL DEFAULT '10',
  PRIMARY KEY (`id`),
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`a2user`@`%`*/ /*!50003 TRIGGER `cc_card_serial_set` BEFORE INSERT ON `cc_card`
 FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`a2user`@`%`*/ /*!50003 TRIGGER `cc_card_serial_update` BEFORE UPDATE ON `cc_card`
 FOR EACH ROW BEGIN
...
CREATE TABLE `cc_country` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=257 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cc_currencies` VALUES (1,'ALL','Albanian Lek (ALL)',0.00974,'2009-05-15 19:38:43','USD'),(2,'DZD','Algerian Dinar (DZD)',0.01345,'2009-05-15 19:38:43','USD'),(3,'XAL','Aluminium Ounces (XAL)',1.08295,'2009-05-15 19:38:43','USD'),(4,'ARS','Argentine Peso (ARS)',0.32455,'2009-05-15 19:38:43','USD'),(5,'AWG','Aruba Florin (AWG)',0.55866,'2009-05-15 19:38:43','USD'),(6,'AUD','Australian Dollar (AUD)',0.73384,'2009-05-15 19:38:43','USD'),(7,'BSD','Bahamian Dollar (BSD)',1.00000,'2009-05-15 19:38:43','USD'),(8,'BHD','Bahraini Dinar (BHD)',2.65322,'2009-05-15 19:38:43','USD'),(9,'BDT','Bangladesh Taka (BDT)',0.01467,'2009-05-15 19:38:43','USD'),(10,'BBD','Barbados Dollar (BBD)',0.50000,'2009-05-15 19:38:43','USD'),(11,'BYR','Belarus Ruble (BYR)',0.00046,'2009-05-15 19:38:43','USD'),(12,'BZD','Belize Dollar (BZD)',0.50569,'2009-05-15 19:38:43','USD'),(13,'BMD','Bermuda Dollar (BMD)',1.00000,'2009-05-15 19:38:43','USD'),(14,'BTN','Bhutan Ngultrum (BTN)',0.02186,'2009-05-15 19:38:43','USD'),(15,'BOB','Bolivian Boliviano (BOB)',0.12500,'2009-05-15 19:38:43','USD'),(16,'BRL','Brazilian Real (BRL)',0.46030,'2009-05-15 19:38:43','USD'),(17,'GBP','British Pound (GBP)',1.73702,'2009-05-15 19:38:43','USD'),(18,'BND','Brunei Dollar (BND)',0.61290,'2009-05-15 19:38:43','USD'),(19,'BGN','Bulgarian Lev (BGN)',0.60927,'2009-05-15 19:38:43','USD'),(20,'BIF','Burundi Franc (BIF)',0.00103,'2009-05-15 19:38:43','USD'),(21,'KHR','Cambodia Riel (KHR)',0.00000,'2009-05-15 19:38:43','USD'),(22,'CAD','Canadian Dollar (CAD)',0.86386,'2009-05-15 19:38:43','USD'),(23,'KYD','Cayman Islands Dollar (KYD)',1.16496,'2009-05-15 19:38:43','USD'),(24,'XOF','CFA Franc (BCEAO) (XOF)',0.00182,'2009-05-15 19:38:43','USD'),(25,'XAF','CFA Franc (BEAC) (XAF)',0.00182,'2009-05-15 19:38:43','USD'),(26,'CLP','Chilean Peso (CLP)',0.00187,'2009-05-15 19:38:43','USD'),(27,'CNY','Chinese Yuan (CNY)',0.12425,'2009-05-15 19:38:43','USD'),(28,'COP','Colombian Peso (COP)',0.00044,'2009-05-15 19:38:43','USD'),(29,'KMF','Comoros Franc (KMF)',0.00242,'2009-05-15 19:38:43','USD'),(30,'XCP','Copper Ounces (XCP)',2.16403,'2009-05-15 19:38:43','USD'),(31,'CRC','Costa Rica Colon (CRC)',0.00199,'2009-05-15 19:38:43','USD'),(32,'HRK','Croatian Kuna (HRK)',0.16249,'2009-05-15 19:38:43','USD'),(33,'CUP','Cuban Peso (CUP)',1.00000,'2009-05-15 19:38:43','USD'),(34,'CYP','Cyprus Pound (CYP)',2.07426,'2009-05-15 19:38:43','USD'),(35,'CZK','Czech Koruna (CZK)',0.04133,'2009-05-15 19:38:43','USD'),(36,'DKK','Danish Krone (DKK)',0.15982,'2009-05-15 19:38:43','USD'),(37,'DJF','Dijibouti Franc (DJF)',0.00000,'2009-05-15 19:38:43','USD'),(38,'DOP','Dominican Peso (DOP)',0.03035,'2009-05-15 19:38:43','USD'),(39,'XCD','East Caribbean Dollar (XCD)',0.37037,'2009-05-15 19:38:43','USD'),(40,'ECS','Ecuador Sucre (ECS)',0.00004,'2009-05-15 19:38:43','USD'),(41,'EGP','Egyptian Pound (EGP)',0.17433,'2009-05-15 19:38:43','USD'),(42,'SVC','El Salvador Colon (SVC)',0.11426,'2009-05-15 19:38:43','USD'),(43,'ERN','Eritrea Nakfa (ERN)',0.00000,'2009-05-15 19:38:43','USD'),(44,'EEK','Estonian Kroon (EEK)',0.07615,'2009-05-15 19:38:43','USD'),(45,'ETB','Ethiopian Birr (ETB)',0.11456,'2009-05-15 19:38:43','USD'),(46,'EUR','Euro (EUR)',1.19175,'2009-05-15 19:38:43','USD'),(47,'FKP','Falkland Islands Pound (FKP)',0.00000,'2009-05-15 19:38:43','USD'),(48,'GMD','Gambian Dalasi (GMD)',0.03515,'2009-05-15 19:38:43','USD'),(49,'GHC','Ghanian Cedi (GHC)',0.00011,'2009-05-15 19:38:43','USD'),(50,'GIP','Gibraltar Pound (GIP)',0.00000,'2009-05-15 19:38:43','USD'),(51,'XAU','Gold Ounces (XAU)',99.99999,'2009-05-15 19:38:43','USD'),(52,'GTQ','Guatemala Quetzal (GTQ)',0.13103,'2009-05-15 19:38:43','USD'),(53,'GNF','Guinea Franc (GNF)',0.00022,'2009-05-15 19:38:43','USD'),(54,'HTG','Haiti Gourde (HTG)',0.02387,'2009-05-15 19:38:43','USD'),(55,'HNL','Honduras Lempira (HNL)',0.05292,'2009-05-15 19:38:43','USD'),(56,'HKD','Hong Kong Dollar (HKD)',0.12884,'2009-05-15 19:38:43','USD'),(57,'HUF','Hungarian ForINT (HUF)',0.00461,'2009-05-15 19:38:43','USD'),(58,'ISK','Iceland Krona (ISK)',0.01436,'2009-05-15 19:38:43','USD'),(59,'INR','Indian Rupee (INR)',0.02253,'2009-05-15 19:38:43','USD'),(60,'IDR','Indonesian Rupiah (IDR)',0.00011,'2009-05-15 19:38:43','USD'),(61,'IRR','Iran Rial (IRR)',0.00011,'2009-05-15 19:38:43','USD'),(62,'ILS','Israeli Shekel (ILS)',0.21192,'2009-05-15 19:38:43','USD'),(63,'JMD','Jamaican Dollar (JMD)',0.01536,'2009-05-15 19:38:43','USD'),(64,'JPY','Japanese Yen (JPY)',0.00849,'2009-05-15 19:38:43','USD'),(65,'JOD','Jordanian Dinar (JOD)',1.41044,'2009-05-15 19:38:43','USD'),(66,'KZT','Kazakhstan Tenge (KZT)',0.00773,'2009-05-15 19:38:43','USD'),(67,'KES','Kenyan Shilling (KES)',0.01392,'2009-05-15 19:38:43','USD'),(68,'KRW','Korean Won (KRW)',0.00102,'2009-05-15 19:38:43','USD'),(69,'KWD','Kuwaiti Dinar (KWD)',3.42349,'2009-05-15 19:38:43','USD'),(70,'LAK','Lao Kip (LAK)',0.00000,'2009-05-15 19:38:43','USD'),(71,'LVL','Latvian Lat (LVL)',1.71233,'2009-05-15 19:38:43','USD'),(72,'LBP','Lebanese Pound (LBP)',0.00067,'2009-05-15 19:38:43','USD'),(73,'LSL','Lesotho Loti (LSL)',0.15817,'2009-05-15 19:38:43','USD'),(74,'LYD','Libyan Dinar (LYD)',0.00000,'2009-05-15 19:38:43','USD'),(75,'LTL','Lithuanian Lita (LTL)',0.34510,'2009-05-15 19:38:43','USD'),(76,'MOP','Macau Pataca (MOP)',0.12509,'2009-05-15 19:38:43','USD'),(77,'MKD','Macedonian Denar (MKD)',0.01945,'2009-05-15 19:38:43','USD'),(78,'MGF','Malagasy Franc (MGF)',0.00011,'2009-05-15 19:38:43','USD'),(79,'MWK','Malawi Kwacha (MWK)',0.00752,'2009-05-15 19:38:43','USD'),(80,'MYR','Malaysian Ringgit (MYR)',0.26889,'2009-05-15 19:38:43','USD'),(81,'MVR','Maldives Rufiyaa (MVR)',0.07813,'2009-05-15 19:38:43','USD'),(82,'MTL','Maltese Lira (MTL)',2.77546,'2009-05-15 19:38:43','USD'),(83,'MRO','Mauritania Ougulya (MRO)',0.00369,'2009-05-15 19:38:43','USD'),(84,'MUR','Mauritius Rupee (MUR)',0.03258,'2009-05-15 19:38:43','USD'),(85,'MXN','Mexican Peso (MXN)',0.09320,'2009-05-15 19:38:43','USD'),(86,'MDL','Moldovan Leu (MDL)',0.07678,'2009-05-15 19:38:43','USD'),(87,'MNT','Mongolian Tugrik (MNT)',0.00084,'2009-05-15 19:38:43','USD'),(88,'MAD','Moroccan Dirham (MAD)',0.10897,'2009-05-15 19:38:43','USD'),(89,'MZM','Mozambique Metical (MZM)',0.00004,'2009-05-15 19:38:43','USD'),(90,'NAD','Namibian Dollar (NAD)',0.15817,'2009-05-15 19:38:43','USD'),(91,'NPR','Nepalese Rupee (NPR)',0.01408,'2009-05-15 19:38:43','USD'),(92,'ANG','Neth Antilles Guilder (ANG)',0.55866,'2009-05-15 19:38:43','USD'),(93,'TRY','New Turkish Lira (TRY)',0.73621,'2009-05-15 19:38:43','USD'),(94,'NZD','New Zealand Dollar (NZD)',0.65096,'2009-05-15 19:38:43','USD'),(95,'NIO','Nicaragua Cordoba (NIO)',0.05828,'2009-05-15 19:38:43','USD'),(96,'NGN','Nigerian Naira (NGN)',0.00777,'2009-05-15 19:38:43','USD'),(97,'NOK','Norwegian Krone (NOK)',0.14867,'2009-05-15 19:38:43','USD'),(98,'OMR','Omani Rial (OMR)',2.59740,'2009-05-15 19:38:43','USD'),(99,'XPF','Pacific Franc (XPF)',0.00999,'2009-05-15 19:38:43','USD'),(100,'PKR','Pakistani Rupee (PKR)',0.01667,'2009-05-15 19:38:43','USD'),(101,'XPD','Palladium Ounces (XPD)',99.99999,'2009-05-15 19:38:43','USD'),(102,'PAB','Panama Balboa (PAB)',1.00000,'2009-05-15 19:38:43','USD'),(103,'PGK','Papua New Guinea Kina (PGK)',0.33125,'2009-05-15 19:38:43','USD'),(104,'PYG','Paraguayan Guarani (PYG)',0.00017,'2009-05-15 19:38:43','USD'),(105,'PEN','Peruvian Nuevo Sol (PEN)',0.29999,'2009-05-15 19:38:43','USD'),(106,'PHP','Philippine Peso (PHP)',0.01945,'2009-05-15 19:38:43','USD'),(107,'XPT','Platinum Ounces (XPT)',99.99999,'2009-05-15 19:38:43','USD'),(108,'PLN','Polish Zloty (PLN)',0.30574,'2009-05-15 19:38:43','USD'),(109,'QAR','Qatar Rial (QAR)',0.27476,'2009-05-15 19:38:43','USD'),(110,'ROL','Romanian Leu (ROL)',0.00000,'2009-05-15 19:38:43','USD'),(111,'RON','Romanian New Leu (RON)',0.34074,'2009-05-15 19:38:43','USD'),(112,'RUB','Russian Rouble (RUB)',0.03563,'2009-05-15 19:38:43','USD'),(113,'RWF','Rwanda Franc (RWF)',0.00185,'2009-05-15 19:38:43','USD'),(114,'WST','Samoa Tala (WST)',0.35492,'2009-05-15 19:38:43','USD'),(115,'STD','Sao Tome Dobra (STD)',0.00000,'2009-05-15 19:38:43','USD'),(116,'SAR','Saudi Arabian Riyal (SAR)',0.26665,'2009-05-15 19:38:43','USD'),(117,'SCR','Seychelles Rupee (SCR)',0.18114,'2009-05-15 19:38:43','USD'),(118,'SLL','Sierra Leone Leone (SLL)',0.00034,'2009-05-15 19:38:43','USD'),(119,'XAG','Silver Ounces (XAG)',9.77517,'2009-05-15 19:38:43','USD'),(120,'SGD','Singapore Dollar (SGD)',0.61290,'2009-05-15 19:38:43','USD'),(121,'SKK','Slovak Koruna (SKK)',0.03157,'2009-05-15 19:38:43','USD'),(122,'SIT','Slovenian Tolar (SIT)',0.00498,'2009-05-15 19:38:43','USD'),(123,'SOS','Somali Shilling (SOS)',0.00000,'2009-05-15 19:38:43','USD'),(124,'ZAR','South African Rand (ZAR)',0.15835,'2009-05-15 19:38:43','USD'),(125,'LKR','Sri Lanka Rupee (LKR)',0.00974,'2009-05-15 19:38:43','USD'),(126,'SHP','St Helena Pound (SHP)',0.00000,'2009-05-15 19:38:43','USD'),(127,'SDD','Sudanese Dinar (SDD)',0.00427,'2009-05-15 19:38:43','USD'),(128,'SRG','Surinam Guilder (SRG)',0.36496,'2009-05-15 19:38:43','USD'),(129,'SZL','Swaziland Lilageni (SZL)',0.15817,'2009-05-15 19:38:43','USD'),(130,'SEK','Swedish Krona (SEK)',0.12609,'2009-05-15 19:38:43','USD'),(131,'CHF','Swiss Franc (CHF)',0.76435,'2009-05-15 19:38:43','USD'),(132,'SYP','Syrian Pound (SYP)',0.00000,'2009-05-15 19:38:43','USD'),(133,'TWD','Taiwan Dollar (TWD)',0.03075,'2009-05-15 19:38:43','USD'),(134,'TZS','Tanzanian Shilling (TZS)',0.00083,'2009-05-15 19:38:43','USD'),(135,'THB','Thai Baht (THB)',0.02546,'2009-05-15 19:38:43','USD'),(136,'TOP','Tonga Paanga (TOP)',0.48244,'2009-05-15 19:38:43','USD'),(137,'TTD','Trinidad&Tobago Dollar (TTD)',0.15863,'2009-05-15 19:38:43','USD'),(138,'TND','Tunisian Dinar (TND)',0.73470,'2009-05-15 19:38:43','USD'),(139,'USD','U.S. Dollar (USD)',1.00000,'2009-05-15 19:38:43','USD'),(140,'AED','UAE Dirham (AED)',0.27228,'2009-05-15 19:38:43','USD'),(141,'UGX','Ugandan Shilling (UGX)',0.00055,'2009-05-15 19:38:43','USD'),(142,'UAH','Ukraine Hryvnia (UAH)',0.19755,'2009-05-15 19:38:43','USD'),(143,'UYU','Uruguayan New Peso (UYU)',0.04119,'2009-05-15 19:38:43','USD'),(144,'VUV','Vanuatu Vatu (VUV)',0.00870,'2009-05-15 19:38:43','USD'),(145,'VEB','Venezuelan Bolivar (VEB)',0.00037,'2009-05-15 19:38:43','USD'),(146,'VND','Vietnam Dong (VND)',0.00006,'2009-05-15 19:38:43','USD'),(147,'YER','Yemen Riyal (YER)',0.00510,'2009-05-15 19:38:43','USD'),(148,'ZMK','Zambian Kwacha (ZMK)',0.00031,'2009-05-15 19:38:43','USD'),(149,'ZWD','Zimbabwe Dollar (ZWD)',0.00001,'2009-05-15 19:38:43','USD'),(150,'GYD','Guyana Dollar (GYD)',0.00527,'2009-05-15 19:38:43','USD');
...
CREATE TABLE `cc_did` (
  ...
  `aleg_timeinterval` text COLLATE utf8_bin,
  ...
  `aleg_carrier_initblock_offp` int(11) NOT NULL DEFAULT '0',
  `aleg_carrier_increment_offp` int(11) NOT NULL DEFAULT '0',
  `aleg_retail_initblock_offp` int(11) NOT NULL DEFAULT '0',
  `aleg_retail_increment_offp` int(11) NOT NULL DEFAULT '0',
  `max_concurrent` int(11) NOT NULL DEFAULT '10',
  PRIMARY KEY (`id`),
...
CREATE TABLE `cc_iax_buddies` (
  ...
  `DEFAULTip` char(50) COLLATE utf8_bin DEFAULT NULL,
  ...
  `ipaddr` char(50) COLLATE utf8_bin NOT NULL DEFAULT '',
  ...
  `sourceaddress` varchar(50) COLLATE utf8_bin NOT NULL DEFAULT '',
...
INSERT INTO `cc_payment_methods` VALUES (1,'paypal','paypal.php'),(3,'MoneyBookers','moneybookers.php'),(4,'plugnpay','plugnpay.php');
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`a2user`@`%`*/ /*!50003 TRIGGER `cc_ratecard_validate_regex_ins` BEFORE INSERT ON `cc_ratecard`
 FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`a2user`@`%`*/ /*!50003 TRIGGER `cc_ratecard_validate_regex_upd` BEFORE UPDATE ON `cc_ratecard`
 FOR EACH ROW BEGIN
  DECLARE valid INTEGER;
  SELECT '0' REGEXP REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(CONCAT('^', NEW.dialprefix, '$'), 'X', '[0-9]'), 'Z', '[1-9]'), 'N', '[2-9]'), '.', '.+'), '_', '') INTO valid;
END */;;
...
INSERT INTO `cc_server_manager` VALUES (1,1,'localhost','localhost','myasterisk','mycode','2009-05-15 19:38:43');
...
CREATE TABLE `cc_sip_buddies` (
  ...
  `nat` char(30) COLLATE utf8_bin DEFAULT 'yes',
  `deny` varchar(95) COLLATE utf8_bin NOT NULL,
  `permit` varchar(95) COLLATE utf8_bin DEFAULT NULL,
  `mask` varchar(95) COLLATE utf8_bin NOT NULL,
...
/*!50001 CREATE TABLE `cc_sip_buddies_empty` (
  ...
  `rtptimeout` tinyint NOT NULL,
  `rtpholdtimeout` tinyint NOT NULL,
  `secret` tinyint NOT NULL,
  `type` tinyint NOT NULL,
  `username` tinyint NOT NULL,
  `disallow` tinyint NOT NULL,
  `allow` tinyint NOT NULL,
  `musiconhold` tinyint NOT NULL,
  `regseconds` tinyint NOT NULL,
  `ipaddr` tinyint NOT NULL,
  `cancallforward` tinyint NOT NULL,
  `fullcontact` tinyint NOT NULL,
  `setvar` tinyint NOT NULL,
  `regserver` tinyint NOT NULL,
  `lastms` tinyint NOT NULL,
  `defaultuser` tinyint NOT NULL,
  `auth` tinyint NOT NULL,
  `subscribemwi` tinyint NOT NULL,
  `vmexten` tinyint NOT NULL,
  `cid_number` tinyint NOT NULL,
  `callingpres` tinyint NOT NULL,
  `usereqphone` tinyint NOT NULL,
  `incominglimit` tinyint NOT NULL,
  `subscribecontext` tinyint NOT NULL,
  `musicclass` tinyint NOT NULL,
  `mohsuggest` tinyint NOT NULL,
  `allowtransfer` tinyint NOT NULL,
  `autoframing` tinyint NOT NULL,
  `maxcallbitrate` tinyint NOT NULL,
  `outboundproxy` tinyint NOT NULL,
  `rtpkeepalive` tinyint NOT NULL,
...
INSERT INTO `cc_system_log` VALUES (5,1,1,'User Logged In','User Logged in to website','','','PP_Intro.php','1.1.1.2','2020-08-15 01:22:39',0),(6,1,1,'Page Visit','User Visited the Page','','','PP_intro.php','1.1.1.2','2020-08-15 01:23:12',0),(7,1,1,'User Logged In','User Logged in to website','','','PP_Intro.php','1.1.1.2','2020-08-15 01:23:12',0),(8,1,1,'Page Visit','User Visited the Page','','','PP_intro.php','1.1.1.2','2020-08-15 01:27:58',0),(9,1,1,'User Logged In','User Logged in to website','','','PP_Intro.php','1.1.1.2','2020-08-15 01:27:58',0),(10,1,1,'Page Visit','User Visited the Page','','','PP_intro.php','1.1.1.2','2020-08-15 01:29:24',0),(11,1,1,'User Logged In','User Logged in to website','','','PP_Intro.php','1.1.1.2','2020-08-15 01:29:24',0),(12,1,1,'Page Visit','User Visited the Page','','','PP_intro.php','1.1.1.2','2020-08-15 01:35:36',0),(13,1,1,'Page Visit','User Visited the Page','','','PP_intro.php','1.1.1.2','2020-08-15 01:35:42',0),(14,1,1,'User Logged In','User Logged in to website','','','PP_Intro.php','1.1.1.2','2020-08-15 01:35:42',0),(15,1,1,'Page Visit','User Visited the Page','','','PP_intro.php','1.1.1.2','2020-08-15 01:35:45',0),(16,1,1,'Page Visit','User Visited the Page','','','PP_intro.php','1.1.1.2','2020-08-15 01:38:11',0),(17,1,1,'User Logged In','User Logged in to website','','','PP_Intro.php','1.1.1.2','2020-08-15 01:38:11',0),(18,1,1,'Page Visit','User Visited the Page','','','A2B_entity_card.php','1.1.1.2','2020-08-15 01:38:23',0),(19,1,1,'Page Visit','User Visited the Page','','','A2B_entity_card.php','1.1.1.2','2020-08-15 01:38:26',0);
...
INSERT INTO `cc_trunk` VALUES (1,'DEFAULT','011','IAX2','examplehost','',0,0,0,'2020-08-15 01:20:25',0,'',NULL,0,-1,1,0);
...
INSERT INTO `cc_ui_authen` VALUES (1,'root','410fc6268dd3332226de95e42d9efa4046c5463769d7493b85e65cfa5c26362dc2455cc23c0bc5831deb008def4ab11a9eaa9b76ba3f377da134f39ec60dd758',0,5242879,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2020-08-15 01:20:25',NULL,NULL,NULL);
...
INSERT INTO `cc_version` VALUES ('2.2.0');
...
/*!50013 DEFINER=`a2user`@`%` SQL SECURITY DEFINER */
...
-- Dump completed on 2020-08-14 22:42:38
